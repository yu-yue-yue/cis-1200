...
public class MarkovChain implements Iterator<String> {
     ...
     */
    void addBigram(String first, String second) throws IllegalArgumentException {
        if (first == null || second == null) {
            throw new IllegalArgumentException();
        }
        ProbabilityDistribution prob = chain.getOrDefault(first, new ProbabilityDistribution<>());
        prob.record(second);
        chain.put(first, prob);
    }
     ...
     * @throws IllegalArgumentException - when parameter is null.
     */
    public void reset(String start) throws IllegalArgumentException {
        if (start == null) {
            throw new IllegalArgumentException("start cannot be null");
        }
        current = start;
        pd = chain.getOrDefault(current, null);
    ...
    public boolean hasNext() {
        return current != END_TOKEN; // Complete this method.
    }
