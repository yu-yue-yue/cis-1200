...
public class TwitterBot {
     ...
     */
    static final String PATH_TO_TWEETS = "files/captain_markov_tweets.csv";
    ...
    public TwitterBot(BufferedReader br, int tweetColumn, NumberGenerator ng) {
        ...
        for (List<String> sentence : data) {
            ...
            BufferedReader newBR = new BufferedReader(new StringReader(s));
            FileLineIterator fli = new FileLineIterator(newBR);
            mc.train(fli);
     ...
     * BufferedRead er. Ensure that each tweet you generate is written on its own
    ...
    public static void main(String[] args) {
        ...
        t.writeStringsToFile(tweets, PATH_TO_OUTPUT_TWEETS, true);
